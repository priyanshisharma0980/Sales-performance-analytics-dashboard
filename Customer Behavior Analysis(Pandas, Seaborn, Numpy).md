...
### How did you calculate the 18% high-value customer figure?
I calculated the total number of unique customers and then counted the number of customers belonging to the high-value segment.  
(high_value_customers / total_customers) × 100   

### How did you calculate the 62% revenue contribution?  
I summed the total revenue generated by high-value customers and divided it by the total revenue from all customers.  
